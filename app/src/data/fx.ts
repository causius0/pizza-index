...
export const FX: Record<string, FxEntry> = {
  ...
  JPY: { perEur: 181.59, src: 'ECB 2026-09-04' },
  KWD: { perEur: 2.80, src: 'indicative (KWD peg ~3.25 USD, EURUSD 1.1622)' },
  THB: { perEur: 38.260, src: 'ECB 2026-09-04' },
  SGD: { perEur: 1.4724, src: 'ECB 2026-09-04' },
  MYR: { perEur: 4.7005, src: 'ECB 2026-09-04' },
